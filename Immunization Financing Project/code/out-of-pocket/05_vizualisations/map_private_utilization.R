##############################################################################################################
# Original Author: Megha Arora
# Date created: 6/7/2016
# Altered by: Scott Swartz, Nat Henry
# Last ediited: 2/6/2020
...
mapping.data <- merge(mapping.data, locations[, .(location_id, ihme_loc_id)], 
...
mapping.data <- mapping.data[, .(mapvar = mean(mapvar)), .(ihme_loc_id, location_id)]
