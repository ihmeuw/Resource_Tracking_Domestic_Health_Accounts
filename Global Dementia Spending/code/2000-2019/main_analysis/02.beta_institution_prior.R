...
# medical_total_cost
pred1 <- predictions[living_conditions == "institution" , c('year_id', 'location_id', "exp_pred")]
...
cmc_raw1 <- cmc_raw2[clean_units == "dx_over_dem_cases"  & year_id > 1994 & living_conditions == "institution", 
...
cmc_covs <- predictions[living_conditions == "institution", c('year_id', 'location_id', "log_the", "sdi")]
