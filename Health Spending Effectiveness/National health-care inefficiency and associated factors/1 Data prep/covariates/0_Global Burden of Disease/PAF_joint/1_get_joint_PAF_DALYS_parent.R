...
### Purpose: Parent script for extracting PAF and DALY draws in parallel.
###          Calls 0_get_joint_PAF_DALYS_child.R in a loop over all locations individually.
###########################################################################
...
child_script = "FILEPATH/0_get_joint_PAF_DALYS.R"
