...
out.dir <- FILEPATH
out.filename <- paste0("2017 OOP spending on Immunizations ", date1, "_", tag, ".pdf")
...
sr_locs
pdf(paste0("FILEPATH/OOP_per_infant_by_country_2000-2017_", date1, "_", tag, ".pdf"))
for (i in c(1:6)) {
...
pdf(paste0("FILEPATH/OOP_by_country_2000-2017_", date1, "_", tag, ".pdf"))
for (i in c(1:6)) {
  a <- ggplot(df[super_region_name == sr_locs[i],], 
