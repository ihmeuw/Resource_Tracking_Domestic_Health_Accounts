# Takes config file for income data and sends job to ST-GPR
# Author: Elye Bliss
# Date: 08/11/2023
...
draws = 100 
model_num = 1 # update this to be the model_index_id you want to use from the config file

# Register an ST-GPR model using a config for non-decom run. 
run_id <- register_stgpr_model('FILEPATH/income_config.csv')
run_id # Note run_id for reference
